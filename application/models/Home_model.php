...
class Home_model extends CI_Model {
    ...
    public function whatsapp($fornecedor_celular) {
        $this->db->select([
            'produtos.*',
            'fornecedor_id',
            'fornecedor_celular as fornecedor_whats',
        ]);

        $this->db->join('fornecedores', 'fornecedor_id = produtos_fornecedor_id', 'LEFT');
        return $this->db->get('fornecedor_celular')->row();
