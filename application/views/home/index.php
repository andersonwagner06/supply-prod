    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-20 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-success">Produtos que podem ser pedidos</h6>
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 15rem;" src="<?php echo base_url('public/img/produtos_vendidos.svg'); ?>" alt="">
                            ...
                            <table class="table table-striped table-borderless">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Celular fornecedor</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <?php endforeach; ?>
                                    <!--
                                    <?php foreach ($fornecedor_produto as $produto): ?>

                                        <tr>
                                            <td><?php echo $produto->fornecedor_id ?></td>
                                            <td class="text-center"><?php echo '<span class="badge badge-success">' . $produto->fornecedor_celular . '</span>' ?></td>
                                        </tr>
                                    ...
                                    <!-- whats app -->
                                    <div id="div_fixa"><a href="whatsapp.php" target="_blank"> <img src="public/img/api-whatsapp-site.jpg" width="54"></a></div>
